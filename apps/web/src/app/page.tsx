      ...
      <section className="px-6 py-20 bg-gradient-to-br from-orange-500 to-amber-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/signup" className="px-8 py-4 bg-white text-orange-600 rounded-xl text-lg font-bold hover:bg-gray-100 transition-all shadow-lg">
            ...
            <Link href="/demo" className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-xl text-lg font-bold hover:bg-white/10 transition-all">
              Try Live Demo
            </Link>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-gray-400 px-6 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm">© 2026 Crew Roster. Data hosted in Sydney, Australia.</p>
            <p className="text-sm">
              Made with ❤️ by{" "}
